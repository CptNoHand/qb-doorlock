...
## Single Door Configuration
      ...
      ['somesingledoor'] = { -- The index of the table, this is used as the doorID
            ...
            authorizedJobs = { ['police', 'fib', 'sheriff', 'detectives'] = 0, ['sheriff'] = 0, ['detectives'] = 0 }, -- Job access (checks for a minimum grade of 0)
            ...
            locked = true,
    items = { ['police_stormram'] = 1 }, -- true or false | Is the door locked by default
