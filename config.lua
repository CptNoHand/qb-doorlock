...
Config.SaveDoorDialog = false -- Saves the door dialogue popup between door saves
...
Config.DoorList['configname-identifier'] = {
	...
	authorizedJobs = { ['police', 'fib', 'sheriff', 'detectives']=0, ['bcso']=0, ['sasp]=0 } -- Authorize door access based on job grade
 ...
 -- Default lock state
		...
		--autolock = 15000, -- Auto lock after this many miliseconds
...
table.insert(Config.DoorList, {
	...
	authorizedJobs = { ['police']=7, ['sheriff']=4, ['fib']=0, ['detectives']=4 },
	locked = true,
    items = { ['police_stormram'] = 1 },        
    -- oldMethod = true,
    -- audioLock = {['file'] = 'metal-locker.ogg', ['volume'] = 0.6},
